...
<form action="{{route('register-user')}}" method="post"  class="" enctype="multipart/form-data" >
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <input type="text-area" name="address" class="form-control" placeholder="Enter Address"  value="{{old('address')}}">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <input type="text" name="nid_number" class="form-control" placeholder="Enter Nid Number"  value="{{old('nid_number')}}">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    <div class="form-outline flex-fill mb-0">
                    <label class="form-label" for="form3Example1c">DL Number</label>
                    <input type="text" name="dl_number" class="form-control" placeholder="Enter Driving License Number"  value="{{old('dl_number')}}">
              ...
              <img src="https://img.freepik.com/premium-vector/car-rental-logo-template-design_316488-1614.jpg?w=826"
